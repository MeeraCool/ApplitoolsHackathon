package com.iexceed.TraditionalTestsV2;
...
public class Task2 extends BaseClass {
	...
	public static String URL = "https://demo.applitools.com/gridHackathonV2.html";
	int iconLoop = 1;
		...
		for (int i = 1; i <= ImageCount.toArray().length; i++) {
			...
			for (int j = 0; j < 3; j++) {
				...
				assertSoft.assertTrue(BaseClass.WriteResult(2, TestName, "Mouse Hover Products-Icon",
						...
						driver.findElement(By.id(Icon_id)).isDisplayed()));
	...
	public void Mobile(String DeviceName, String BrowserName, int viewPortWidth, int viewPortHeight)
		...
		assertSoft.assertTrue(BaseClass.WriteResult(1, "Cross Browser Elements Test", "Landing Screen",
		...
		assertSoft.assertTrue(
				BaseClass.WriteResult(1, "Cross Browser Elements Test", "Landing Screen", "Header Section-My Cart Icon",
